...
.panel{background:#ffffffed;border:1px solid var(--line);border-radius:24px;padding:32px;box-shadow:0 24px 70px #4d23751a;backdrop-filter:blur(8px);border-top:4px solid #9a63c4}h1{font-size:32px;margin:0 0 8px;color:var(--purple-dark)}.sub{color:var(--muted);margin:0 0 28px}
.drop{display:block;border:2px dashed #b995d4;border-radius:16px;padding:34px;text-align:center;background:var(--purple-soft);cursor:pointer;transition:.18s ease}.drop:hover{border-color:var(--purple);background:#eadcf6;transform:translateY(-1px)}.drop strong{display:block;font-size:17px;color:var(--purple-dark)}.drop span{color:var(--muted)}
